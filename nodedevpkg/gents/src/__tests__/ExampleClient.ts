...
export const uploadBlob = /*#__PURE__*/ createRequest<
  ...
  null
>("UploadBlob", ({ "Content-Type": header_contentType, body: body }) => ({
  method: "PUT",
...
export const listKubePkg = /*#__PURE__*/ createRequest<void, Array<KubepkgV1Alpha1KubePkg>>("ListKubePkg", () => ({
  method: "GET",
...
>("ApplyKubePkg", ({ body: body, "Content-Type": contentType }) => ({
  method: "PUT",
  url: "/api/kubepkg.innoai.tech/v1/kubepkgs",
  body: body,
  headers: {
...
export const delKubePkg = /*#__PURE__*/ createRequest<
  ...
  null
>("DelKubePkg", ({ name: path_name, namespace: query_namespace }) => ({
  method: "DELETE",
...
export const getKubePkg = /*#__PURE__*/ createRequest<
  ...
  KubepkgV1Alpha1KubePkg
>("GetKubePkg", ({ name: path_name, namespace: query_namespace }) => ({
  method: "GET",
  url: `/api/kubepkg.innoai.tech/v1/kubepkgs/${path_name}`,
  params: {
    namespace: query_namespace,
